...
<CardGroup cols={3}>
  <Card title="API Reference" icon="code" href="/api/data-connectors">
    Complete data connectors API documentation
  </Card>

  <Card title="Supported Databases" icon="database" href="/guides/supported-databases">
    Full list of supported data sources
  </Card>

  <Card title="Security Guide" icon="shield" href="/guides/data-connector-security">
