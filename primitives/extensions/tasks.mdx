...
<CardGroup cols={3}>
  <Card title="API Reference" icon="code" href="/api/tasks">
    Complete tasks API documentation
  </Card>

  <Card title="Task Templates" icon="template" href="/guides/task-templates">
    Pre-built task templates library
  </Card>

  <Card title="Best Practices" icon="star" href="/guides/task-management">
