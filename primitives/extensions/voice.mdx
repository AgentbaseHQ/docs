...
<CardGroup cols={3}>
  <Card title="API Reference" icon="code" href="/api/voice">
    Complete voice API documentation
  </Card>

  <Card title="Voice Design Guide" icon="book" href="/guides/voice-design">
    Best practices for voice UX
  </Card>

  <Card title="Examples" icon="lightbulb" href="/examples/voice">
