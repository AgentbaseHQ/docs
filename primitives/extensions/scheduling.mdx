...
<CardGroup cols={3}>
  <Card title="API Reference" icon="code" href="/api/scheduling">
    Complete scheduling API documentation
  </Card>

  <Card title="Cron Guide" icon="book" href="/guides/cron-expressions">
    Cron expression syntax and examples
  </Card>

  <Card title="Time Zones" icon="globe" href="/guides/timezones">
