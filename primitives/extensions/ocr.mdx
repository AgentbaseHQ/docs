...
<CardGroup cols={3}>
  <Card title="API Reference" icon="code" href="/api/ocr">
    Complete OCR API documentation
  </Card>

  <Card title="Supported Formats" icon="file" href="/guides/ocr-formats">
    List of supported image and document formats
  </Card>

  <Card title="Best Practices" icon="star" href="/guides/ocr-best-practices">
