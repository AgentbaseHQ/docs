...
<CardGroup cols={3}>
  <Card title="API Reference" icon="code" href="/api/orchestration">
    Complete orchestration API docs
  </Card>

  <Card title="Orchestration Patterns" icon="book" href="/guides/orchestration-patterns">
    Common design patterns
  </Card>

  <Card title="Examples" icon="lightbulb" href="/examples/orchestration">
    Real-world examples
  </Card>
</CardGroup>
