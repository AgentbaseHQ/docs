...
<CardGroup cols={3}>
  <Card title="API Reference" icon="code" href="/api/interface">
    Complete interface API docs
  </Card>

  <Card title="UI Components" icon="palette" href="/components">
    Pre-built UI component library
  </Card>

  <Card title="Design Guide" icon="paintbrush" href="/guides/interface-design">
