---
title: 'Capabilities'
description: 'Built-in tools and enterprise-grade capabilities available to every Agentbase agent.'
---

Agents on Agentbase come equipped with a rich set of tools covering intelligence, environment control, data processing, and enterprise-grade governance.

<Note>
  Many of these capabilities are already implemented, with others being added one-by-one. We offer early access programs for individual features through our API. To get early access to specific capabilities, reach out through our [Discord community](https://discord.com/invite/KFtqf7j9fs), support channels, or contact our team directly.
</Note>
