...
<CardGroup cols={2}>
  ...
  <Card title="Improve & Optimize" icon="chart-line" href="/improve/overview">
    Monitor performance, reduce costs, and enhance quality
  </Card>
...
| **Fast** | $0.05 | Most production use cases |
...
<CardGroup cols={2}>
  ...
  <Card title="TypeScript SDK" icon="js" href="/deploy/sdk/typescript">
    Type-safe integration for Node.js apps
  </Card>

  <Card title="Python SDK" icon="python" href="/deploy/sdk/python">
