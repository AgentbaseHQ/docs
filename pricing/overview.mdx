...
|------|-------------|---------------|-------------|----------|
| **Fast** | < 30k tokens | **$0.005** | **$0.0005** | Simple tasks, high-volume operations |
| | 30k - 128k tokens | **$0.012** | **$0.0012** | Larger simple tasks |
| **Flash** | < 30k tokens | **$0.05** | **$0.005** | Balanced workflows (recommended) |
| | 30k - 128k tokens | **$0.12** | **$0.012** | Complex tasks with larger context |
| **Max** | < 30k tokens | **$0.15** | **$0.015** | Advanced reasoning and analysis |
| | 30k - 128k tokens | **$0.40** | **$0.04** | Complex large-context tasks |
...
**Cached rates** apply when context is reused across steps - **up to 90% savings** on repeated context processing. Perfect for conversational agents and recurring workflows.

**Example Savings:**
```
Standard workflow: 5 steps × $0.05 = $0.25
With caching: 1 step × $0.05 + 4 steps × $0.005 = $0.07
Savings: 72% reduction in total cost
```
