---
title: 'What is the Agentic API?'
description: 'Learn about the core concepts behind Pointer’s Agentic API.'
---

The Agentic API is a simple, production-grade interface for interacting with persistent, intelligent AI agents running on Pointer's managed infrastructure.
...
Pointer’s Agentic API is designed to be:
...
- **Secure**: Built with enterprise-grade security and session management. 